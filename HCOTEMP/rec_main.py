...
def parse_args():
    ...
    path_settings.add_argument('--test_file', default='test_neg.csv',
...
if __name__ == '__main__':
    ...
    class FilePaths(object):
        def __init__(self):
            self.train_file = os.path.join(args.processed_dir, 'train_{}.pkl'.format(args.P) if args.period else 'train.pkl')
            self.valid_file = os.path.join(args.processed_dir, 'valid_{}.pkl'.format(args.P) if args.period else 'valid.pkl')
            self.test_file = os.path.join(args.processed_dir, 'test_{}.pkl'.format(args.P) if args.period else 'test.pkl')
